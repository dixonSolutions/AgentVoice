/**
 * Wake phrase matching, shared by every client.
 *
 * The phone (Vosk spotters) and the editor (post-transcription routing) must
 * agree about what counts as saying the start, submit or cancel word — a
 * second implementation is how "send" stopped submitting in the editor while
 * it still worked on the phone. One module, both callers.
 */
